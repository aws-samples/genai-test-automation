    ...
    private static void runTestAmazonCart() throws Exception{
        ...
        try {
            ...
            .andThen(new Navigate(CommandParams.builder()
                .url("https://www.amazon.com/")
                .testCase("""
                        You are testing the amazon.com web application. Your test case is to add to cart the most expensive soccer ball size 3. The test case finishes when the soccer ball is visible within the cart. You should monitor the number of items in the cart.
                """)
                .build()))
            .tearDown();
